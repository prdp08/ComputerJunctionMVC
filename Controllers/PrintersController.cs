...
namespace ComputerJunctionMVC.Controllers
{
    [Authorize]
    public class PrintersController : Controller
    {
        ...
        public PrintersController(ComputerDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,Price")] Printer printer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,Price")] Printer printer)
        {
            if (id != printer.ID)
            {
                return NotFound();
